...
class SearchParametersIVF(SearchParameters):
    ...
    selector_probe_limit = property(_swigfaiss.SearchParametersIVF_selector_probe_limit_get, _swigfaiss.SearchParametersIVF_selector_probe_limit_set)
...
class IndexIVFInterface(Level1Quantizer):
    ...
    selector_probe_limit = property(_swigfaiss.IndexIVFInterface_selector_probe_limit_get, _swigfaiss.IndexIVFInterface_selector_probe_limit_set)
    ...
    def search_preassigned(self, n, x, k, assign, centroid_dis, np, distances, labels, store_pairs, params=None, stats=None):
        ...
        """
        return _swigfaiss.IndexIVFInterface_search_preassigned(self, n, x, k, assign, centroid_dis, np, distances, labels, store_pairs, params, stats)
...
class IndexIVF(Index, IndexIVFInterface):
    ...
    def search_preassigned(self, n, x, k, assign, centroid_dis, np, distances, labels, store_pairs, params=None, stats=None):
        return _swigfaiss.IndexIVF_search_preassigned(self, n, x, k, assign, centroid_dis, np, distances, labels, store_pairs, params, stats)
...
class IndexIVFFlatDedup(IndexIVFFlat):
    ...
    def search_preassigned(self, n, x, k, assign, centroid_dis, np, distances, labels, store_pairs, params=None, stats=None):
        return _swigfaiss.IndexIVFFlatDedup_search_preassigned(self, n, x, k, assign, centroid_dis, np, distances, labels, store_pairs, params, stats)
...
class IndexIVFPQR(IndexIVFPQ):
    ...
    def search_preassigned(self, n, x, k, assign, centroid_dis, np, distances, labels, store_pairs, params=None, stats=None):
        return _swigfaiss.IndexIVFPQR_search_preassigned(self, n, x, k, assign, centroid_dis, np, distances, labels, store_pairs, params, stats)
...
class IDSelectorIVF(IDSelector):
    ...
    def set_list(self, list_no):
        return _swigfaiss.IDSelectorIVF_set_list(self, list_no)
    __swig_destroy__ = _swigfaiss.delete_IDSelectorIVF

# Register IDSelectorIVF in _swigfaiss:
_swigfaiss.IDSelectorIVF_swigregister(IDSelectorIVF)

class IDSelectorIVFSingle(IDSelectorIVF):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    n = property(_swigfaiss.IDSelectorIVFSingle_n_get, _swigfaiss.IDSelectorIVFSingle_n_set)
    ids = property(_swigfaiss.IDSelectorIVFSingle_ids_get, _swigfaiss.IDSelectorIVFSingle_ids_set)
    offset = property(_swigfaiss.IDSelectorIVFSingle_offset_get, _swigfaiss.IDSelectorIVFSingle_offset_set)

    def __init__(self, n, ids):
        _swigfaiss.IDSelectorIVFSingle_swiginit(self, _swigfaiss.new_IDSelectorIVFSingle(n, ids))

    def set_list(self, list_no):
        return _swigfaiss.IDSelectorIVFSingle_set_list(self, list_no)

    def is_member(self, id):
        return _swigfaiss.IDSelectorIVFSingle_is_member(self, id)
    __swig_destroy__ = _swigfaiss.delete_IDSelectorIVFSingle

# Register IDSelectorIVFSingle in _swigfaiss:
_swigfaiss.IDSelectorIVFSingle_swigregister(IDSelectorIVFSingle)

class IDSelectorIVFTwo(IDSelectorIVF):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ids = property(_swigfaiss.IDSelectorIVFTwo_ids_get, _swigfaiss.IDSelectorIVFTwo_ids_set)
    limits = property(_swigfaiss.IDSelectorIVFTwo_limits_get, _swigfaiss.IDSelectorIVFTwo_limits_set)
    sel1 = property(_swigfaiss.IDSelectorIVFTwo_sel1_get, _swigfaiss.IDSelectorIVFTwo_sel1_set)
    sel2 = property(_swigfaiss.IDSelectorIVFTwo_sel2_get, _swigfaiss.IDSelectorIVFTwo_sel2_set)

    def __init__(self, ids, limits):
        _swigfaiss.IDSelectorIVFTwo_swiginit(self, _swigfaiss.new_IDSelectorIVFTwo(ids, limits))

    def set_words(self, w1, w2=-1):
        return _swigfaiss.IDSelectorIVFTwo_set_words(self, w1, w2)

    def set_list(self, list_no):
        return _swigfaiss.IDSelectorIVFTwo_set_list(self, list_no)

    def is_member(self, id):
        return _swigfaiss.IDSelectorIVFTwo_is_member(self, id)
    __swig_destroy__ = _swigfaiss.delete_IDSelectorIVFTwo

# Register IDSelectorIVFTwo in _swigfaiss:
_swigfaiss.IDSelectorIVFTwo_swigregister(IDSelectorIVFTwo)

class IDSelectorIVFClusterAware(IDSelectorIVF):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ids = property(_swigfaiss.IDSelectorIVFClusterAware_ids_get, _swigfaiss.IDSelectorIVFClusterAware_ids_set)
    limits = property(_swigfaiss.IDSelectorIVFClusterAware_limits_get, _swigfaiss.IDSelectorIVFClusterAware_limits_set)
    clusters = property(_swigfaiss.IDSelectorIVFClusterAware_clusters_get, _swigfaiss.IDSelectorIVFClusterAware_clusters_set)
    cluster_limits = property(_swigfaiss.IDSelectorIVFClusterAware_cluster_limits_get, _swigfaiss.IDSelectorIVFClusterAware_cluster_limits_set)
    limit_w1_low = property(_swigfaiss.IDSelectorIVFClusterAware_limit_w1_low_get, _swigfaiss.IDSelectorIVFClusterAware_limit_w1_low_set)
    limit_w1_high = property(_swigfaiss.IDSelectorIVFClusterAware_limit_w1_high_get, _swigfaiss.IDSelectorIVFClusterAware_limit_w1_high_set)
    limit_w2_low = property(_swigfaiss.IDSelectorIVFClusterAware_limit_w2_low_get, _swigfaiss.IDSelectorIVFClusterAware_limit_w2_low_set)
    limit_w2_high = property(_swigfaiss.IDSelectorIVFClusterAware_limit_w2_high_get, _swigfaiss.IDSelectorIVFClusterAware_limit_w2_high_set)
    found_cluster_w1 = property(_swigfaiss.IDSelectorIVFClusterAware_found_cluster_w1_get, _swigfaiss.IDSelectorIVFClusterAware_found_cluster_w1_set)
    found_cluster_w2 = property(_swigfaiss.IDSelectorIVFClusterAware_found_cluster_w2_get, _swigfaiss.IDSelectorIVFClusterAware_found_cluster_w2_set)
    sel1 = property(_swigfaiss.IDSelectorIVFClusterAware_sel1_get, _swigfaiss.IDSelectorIVFClusterAware_sel1_set)
    sel2 = property(_swigfaiss.IDSelectorIVFClusterAware_sel2_get, _swigfaiss.IDSelectorIVFClusterAware_sel2_set)

    def __init__(self, ids, limits, clusters, cluster_limits):
        _swigfaiss.IDSelectorIVFClusterAware_swiginit(self, _swigfaiss.new_IDSelectorIVFClusterAware(ids, limits, clusters, cluster_limits))

    def set_words(self, w1, w2=-1):
        return _swigfaiss.IDSelectorIVFClusterAware_set_words(self, w1, w2)

    def set_list(self, list_no):
        return _swigfaiss.IDSelectorIVFClusterAware_set_list(self, list_no)

    def is_member(self, id):
        return _swigfaiss.IDSelectorIVFClusterAware_is_member(self, id)
    __swig_destroy__ = _swigfaiss.delete_IDSelectorIVFClusterAware

# Register IDSelectorIVFClusterAware in _swigfaiss:
_swigfaiss.IDSelectorIVFClusterAware_swigregister(IDSelectorIVFClusterAware)

class IDSelectorIVFClusterAwareIntersect(IDSelectorIVF):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ids = property(_swigfaiss.IDSelectorIVFClusterAwareIntersect_ids_get, _swigfaiss.IDSelectorIVFClusterAwareIntersect_ids_set)
    limits = property(_swigfaiss.IDSelectorIVFClusterAwareIntersect_limits_get, _swigfaiss.IDSelectorIVFClusterAwareIntersect_limits_set)
    clusters = property(_swigfaiss.IDSelectorIVFClusterAwareIntersect_clusters_get, _swigfaiss.IDSelectorIVFClusterAwareIntersect_clusters_set)
    cluster_limits = property(_swigfaiss.IDSelectorIVFClusterAwareIntersect_cluster_limits_get, _swigfaiss.IDSelectorIVFClusterAwareIntersect_cluster_limits_set)
    tmp = property(_swigfaiss.IDSelectorIVFClusterAwareIntersect_tmp_get, _swigfaiss.IDSelectorIVFClusterAwareIntersect_tmp_set)
    limit_w1_low = property(_swigfaiss.IDSelectorIVFClusterAwareIntersect_limit_w1_low_get, _swigfaiss.IDSelectorIVFClusterAwareIntersect_limit_w1_low_set)
    limit_w1_high = property(_swigfaiss.IDSelectorIVFClusterAwareIntersect_limit_w1_high_get, _swigfaiss.IDSelectorIVFClusterAwareIntersect_limit_w1_high_set)
    limit_w2_low = property(_swigfaiss.IDSelectorIVFClusterAwareIntersect_limit_w2_low_get, _swigfaiss.IDSelectorIVFClusterAwareIntersect_limit_w2_low_set)
    limit_w2_high = property(_swigfaiss.IDSelectorIVFClusterAwareIntersect_limit_w2_high_get, _swigfaiss.IDSelectorIVFClusterAwareIntersect_limit_w2_high_set)
    found_cluster_w = property(_swigfaiss.IDSelectorIVFClusterAwareIntersect_found_cluster_w_get, _swigfaiss.IDSelectorIVFClusterAwareIntersect_found_cluster_w_set)
    sel = property(_swigfaiss.IDSelectorIVFClusterAwareIntersect_sel_get, _swigfaiss.IDSelectorIVFClusterAwareIntersect_sel_set)

    def __init__(self, ids, limits, clusters, cluster_limits, size_tmp):
        _swigfaiss.IDSelectorIVFClusterAwareIntersect_swiginit(self, _swigfaiss.new_IDSelectorIVFClusterAwareIntersect(ids, limits, clusters, cluster_limits, size_tmp))

    def set_words(self, w1, w2=-1):
        return _swigfaiss.IDSelectorIVFClusterAwareIntersect_set_words(self, w1, w2)

    def set_list(self, list_no):
        return _swigfaiss.IDSelectorIVFClusterAwareIntersect_set_list(self, list_no)

    def is_member(self, id):
        return _swigfaiss.IDSelectorIVFClusterAwareIntersect_is_member(self, id)
    __swig_destroy__ = _swigfaiss.delete_IDSelectorIVFClusterAwareIntersect

# Register IDSelectorIVFClusterAwareIntersect in _swigfaiss:
_swigfaiss.IDSelectorIVFClusterAwareIntersect_swigregister(IDSelectorIVFClusterAwareIntersect)
...
class IDSelectorIVFDirect(IDSelectorIVF):
    ...
    def get_size(self):
        return _swigfaiss.IDSelectorIVFDirect_get_size(self)

    def get_range(self):
        return _swigfaiss.IDSelectorIVFDirect_get_range(self)

    def get_num_clusters(self):
        return _swigfaiss.IDSelectorIVFDirect_get_num_clusters(self)

    def get_clusters(self, destination):
        return _swigfaiss.IDSelectorIVFDirect_get_clusters(self, destination)
    __swig_destroy__ = _swigfaiss.delete_IDSelectorIVFDirect

# Register IDSelectorIVFDirect in _swigfaiss:
_swigfaiss.IDSelectorIVFDirect_swigregister(IDSelectorIVFDirect)

class IDSelectorIVFClusterAwareIntersectDirect(IDSelectorIVFDirect):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    in_cluster_positions = property(_swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_in_cluster_positions_get, _swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_in_cluster_positions_set)
    limits = property(_swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_limits_get, _swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_limits_set)
    clusters = property(_swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_clusters_get, _swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_clusters_set)
    cluster_limits = property(_swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_cluster_limits_get, _swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_cluster_limits_set)
    tmp = property(_swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_tmp_get, _swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_tmp_set)
    range = property(_swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_range_get, _swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_range_set)
    range_size = property(_swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_range_size_get, _swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_range_size_set)
    is_first_smallest_cluster = property(_swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_is_first_smallest_cluster_get, _swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_is_first_smallest_cluster_set)
    limit_w1_low = property(_swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_limit_w1_low_get, _swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_limit_w1_low_set)
    limit_w1_high = property(_swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_limit_w1_high_get, _swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_limit_w1_high_set)
    limit_w2_low = property(_swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_limit_w2_low_get, _swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_limit_w2_low_set)
    limit_w2_high = property(_swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_limit_w2_high_get, _swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_limit_w2_high_set)

    def get_size(self):
        return _swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_get_size(self)

    def get_range(self):
        return _swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_get_range(self)

    def get_num_clusters(self):
        return _swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_get_num_clusters(self)

    def get_clusters(self, destination):
        return _swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_get_clusters(self, destination)

    def __init__(self, in_cluster_positions, limits, clusters, cluster_limits, size_tmp):
        _swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_swiginit(self, _swigfaiss.new_IDSelectorIVFClusterAwareIntersectDirect(in_cluster_positions, limits, clusters, cluster_limits, size_tmp))

    def set_words(self, w1, w2=-1):
        return _swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_set_words(self, w1, w2)

    def set_list(self, list_no):
        return _swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_set_list(self, list_no)

    def is_member(self, id):
        return _swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_is_member(self, id)
    __swig_destroy__ = _swigfaiss.delete_IDSelectorIVFClusterAwareIntersectDirect

# Register IDSelectorIVFClusterAwareIntersectDirect in _swigfaiss:
_swigfaiss.IDSelectorIVFClusterAwareIntersectDirect_swigregister(IDSelectorIVFClusterAwareIntersectDirect)

class IDSelectorIVFClusterAwareIntersectDirectExp(IDSelectorIVFDirect):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    nprobes = property(_swigfaiss.IDSelectorIVFClusterAwareIntersectDirectExp_nprobes_get)
    in_cluster_positions = property(_swigfaiss.IDSelectorIVFClusterAwareIntersectDirectExp_in_cluster_positions_get, _swigfaiss.IDSelectorIVFClusterAwareIntersectDirectExp_in_cluster_positions_set)
    limits = property(_swigfaiss.IDSelectorIVFClusterAwareIntersectDirectExp_limits_get, _swigfaiss.IDSelectorIVFClusterAwareIntersectDirectExp_limits_set)
    tmp = property(_swigfaiss.IDSelectorIVFClusterAwareIntersectDirectExp_tmp_get, _swigfaiss.IDSelectorIVFClusterAwareIntersectDirectExp_tmp_set)
    range = property(_swigfaiss.IDSelectorIVFClusterAwareIntersectDirectExp_range_get, _swigfaiss.IDSelectorIVFClusterAwareIntersectDirectExp_range_set)
    range_size = property(_swigfaiss.IDSelectorIVFClusterAwareIntersectDirectExp_range_size_get, _swigfaiss.IDSelectorIVFClusterAwareIntersectDirectExp_range_size_set)
    w1 = property(_swigfaiss.IDSelectorIVFClusterAwareIntersectDirectExp_w1_get, _swigfaiss.IDSelectorIVFClusterAwareIntersectDirectExp_w1_set)
    w2 = property(_swigfaiss.IDSelectorIVFClusterAwareIntersectDirectExp_w2_get, _swigfaiss.IDSelectorIVFClusterAwareIntersectDirectExp_w2_set)

    def get_size(self):
        return _swigfaiss.IDSelectorIVFClusterAwareIntersectDirectExp_get_size(self)

    def get_range(self):
        return _swigfaiss.IDSelectorIVFClusterAwareIntersectDirectExp_get_range(self)

    def __init__(self, in_cluster_positions, limits, nprobe, size_tmp):
        _swigfaiss.IDSelectorIVFClusterAwareIntersectDirectExp_swiginit(self, _swigfaiss.new_IDSelectorIVFClusterAwareIntersectDirectExp(in_cluster_positions, limits, nprobe, size_tmp))

    def set_words(self, w1, w2=-1):
        return _swigfaiss.IDSelectorIVFClusterAwareIntersectDirectExp_set_words(self, w1, w2)

    def set_list(self, list_no):
        return _swigfaiss.IDSelectorIVFClusterAwareIntersectDirectExp_set_list(self, list_no)

    def is_member(self, id):
        return _swigfaiss.IDSelectorIVFClusterAwareIntersectDirectExp_is_member(self, id)
    __swig_destroy__ = _swigfaiss.delete_IDSelectorIVFClusterAwareIntersectDirectExp

# Register IDSelectorIVFClusterAwareIntersectDirectExp in _swigfaiss:
_swigfaiss.IDSelectorIVFClusterAwareIntersectDirectExp_swigregister(IDSelectorIVFClusterAwareIntersectDirectExp)

class IDSelectorMyStats(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    intersection = property(_swigfaiss.IDSelectorMyStats_intersection_get, _swigfaiss.IDSelectorMyStats_intersection_set)
    find_cluster = property(_swigfaiss.IDSelectorMyStats_find_cluster_get, _swigfaiss.IDSelectorMyStats_find_cluster_set)
    set_list_time = property(_swigfaiss.IDSelectorMyStats_set_list_time_get, _swigfaiss.IDSelectorMyStats_set_list_time_set)
    one_list = property(_swigfaiss.IDSelectorMyStats_one_list_get, _swigfaiss.IDSelectorMyStats_one_list_set)
    scan_codes = property(_swigfaiss.IDSelectorMyStats_scan_codes_get, _swigfaiss.IDSelectorMyStats_scan_codes_set)
    extra = property(_swigfaiss.IDSelectorMyStats_extra_get, _swigfaiss.IDSelectorMyStats_extra_set)

    def __init__(self):
        _swigfaiss.IDSelectorMyStats_swiginit(self, _swigfaiss.new_IDSelectorMyStats())

    def reset(self):
        return _swigfaiss.IDSelectorMyStats_reset(self)
    __swig_destroy__ = _swigfaiss.delete_IDSelectorMyStats

# Register IDSelectorMyStats in _swigfaiss:
_swigfaiss.IDSelectorMyStats_swigregister(IDSelectorMyStats)

class IDSelectorFilterWise(IDSelectorIVFDirect):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    in_cluster_positions = property(_swigfaiss.IDSelectorFilterWise_in_cluster_positions_get, _swigfaiss.IDSelectorFilterWise_in_cluster_positions_set)
    limits = property(_swigfaiss.IDSelectorFilterWise_limits_get, _swigfaiss.IDSelectorFilterWise_limits_set)
    clusters = property(_swigfaiss.IDSelectorFilterWise_clusters_get, _swigfaiss.IDSelectorFilterWise_clusters_set)
    cluster_limits = property(_swigfaiss.IDSelectorFilterWise_cluster_limits_get, _swigfaiss.IDSelectorFilterWise_cluster_limits_set)
    tmp = property(_swigfaiss.IDSelectorFilterWise_tmp_get, _swigfaiss.IDSelectorFilterWise_tmp_set)
    range = property(_swigfaiss.IDSelectorFilterWise_range_get, _swigfaiss.IDSelectorFilterWise_range_set)
    range_size = property(_swigfaiss.IDSelectorFilterWise_range_size_get, _swigfaiss.IDSelectorFilterWise_range_size_set)
    is_first_smallest_cluster = property(_swigfaiss.IDSelectorFilterWise_is_first_smallest_cluster_get, _swigfaiss.IDSelectorFilterWise_is_first_smallest_cluster_set)
    limit_w1_low = property(_swigfaiss.IDSelectorFilterWise_limit_w1_low_get, _swigfaiss.IDSelectorFilterWise_limit_w1_low_set)
    limit_w1_high = property(_swigfaiss.IDSelectorFilterWise_limit_w1_high_get, _swigfaiss.IDSelectorFilterWise_limit_w1_high_set)
    limit_w2_low = property(_swigfaiss.IDSelectorFilterWise_limit_w2_low_get, _swigfaiss.IDSelectorFilterWise_limit_w2_low_set)
    limit_w2_high = property(_swigfaiss.IDSelectorFilterWise_limit_w2_high_get, _swigfaiss.IDSelectorFilterWise_limit_w2_high_set)

    def get_size(self):
        return _swigfaiss.IDSelectorFilterWise_get_size(self)

    def get_range(self):
        return _swigfaiss.IDSelectorFilterWise_get_range(self)

    def get_num_clusters(self):
        return _swigfaiss.IDSelectorFilterWise_get_num_clusters(self)

    def get_clusters(self, destination):
        return _swigfaiss.IDSelectorFilterWise_get_clusters(self, destination)

    def __init__(self, in_cluster_positions, limits, clusters, cluster_limits, size_tmp):
        _swigfaiss.IDSelectorFilterWise_swiginit(self, _swigfaiss.new_IDSelectorFilterWise(in_cluster_positions, limits, clusters, cluster_limits, size_tmp))

    def set_words(self, w1, w2=-1):
        return _swigfaiss.IDSelectorFilterWise_set_words(self, w1, w2)

    def set_list(self, list_no):
        return _swigfaiss.IDSelectorFilterWise_set_list(self, list_no)

    def is_member(self, id):
        return _swigfaiss.IDSelectorFilterWise_is_member(self, id)
    __swig_destroy__ = _swigfaiss.delete_IDSelectorFilterWise

# Register IDSelectorFilterWise in _swigfaiss:
_swigfaiss.IDSelectorFilterWise_swigregister(IDSelectorFilterWise)
